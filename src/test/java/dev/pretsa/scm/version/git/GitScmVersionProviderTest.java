...
class GitScmVersionProviderTest {

    @TempDir
    Path tempDir;

    GitScmVersionProvider gitScmVersionProvider = new GitScmVersionProvider();
    ...
    void repoWithSemanticVersionTag(String tag) throws GitAPIException {
        try (Git git = Git.init().setDirectory(tempDir.toFile()).call()) {
            ...
            String version = gitScmVersionProvider.getLatestVersion(tempDir);
