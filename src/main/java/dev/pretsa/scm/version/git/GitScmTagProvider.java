...
@Named
@Singleton
public class GitScmTagProvider implements ScmTagProvider {
    ...
    public String getLatestTag(Path directory) {
        ...
        FileRepositoryBuilder repositoryBuilder =
                new FileRepositoryBuilder().readEnvironment().findGitDir(directory.toFile());
        try (Repository repository = repositoryBuilder.build();
            ...
            logger.atWarn().addArgument(directory).addArgument(e.getMessage()).log("Error loading tag at {}: {}");
