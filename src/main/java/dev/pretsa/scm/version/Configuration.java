...
/**
 * Configuration needed to load the current tag from scm and resolve the version
...
public record Configuration(
        ...
        Version.Component nextVersionComponent,
        VersionQualifier versionQualifier) {

    /**
     * Property key for the final version to be used as the project version
     */
    ...
    /**
     * Property key denoting next version component {@link Version.Component#MAJOR}
     */
    public static final String KEY_MAJOR = "scm.major";

    /**
     * Property key denoting next version component {@link Version.Component#MINOR}
     */
    public static final String KEY_MINOR = "scm.minor";

    /**
     * Property key denoting next version component {@link Version.Component#PATCH}
     */
    ...
    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#MAJOR} and version qualifier {@link VersionQualifier#RELEASE}
     */
    public static final String KEY_NEXT_MAJOR_RELEASE = "scm.next.major.release";

    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#MINOR} and version qualifier {@link VersionQualifier#RELEASE}
     */
    public static final String KEY_NEXT_MINOR_RELEASE = "scm.next.minor.release";

    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#PATCH} and version qualifier {@link VersionQualifier#RELEASE}
     */
    public static final String KEY_NEXT_PATCH_RELEASE = "scm.next.patch.release";

    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#MAJOR} and version qualifier {@link VersionQualifier#SNAPSHOT}
     */
    public static final String KEY_NEXT_MAJOR_SNAPSHOT = "scm.next.major.snapshot";

    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#MINOR} and version qualifier {@link VersionQualifier#SNAPSHOT}
     */
    public static final String KEY_NEXT_MINOR_SNAPSHOT = "scm.next.minor.snapshot";

    /**
     * Property key denoting version type {@link VersionType#NEXT}, next version component {@link Version.Component#PATCH} and version qualifier {@link VersionQualifier#SNAPSHOT}
     */
